 ...
 */ var base64 = __webpack_require__(7526);
            ...
            8636 (module1, __unused_rspack_exports, __webpack_require__) {
                ...
                var stringify = function stringify(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel, depth, currentDepth) {
                    ...
                    obj = 'function' == typeof filter ? filter(prefix, obj) : obj;
                    ...
                    if (allowEmptyArrays && isArray(obj) && 0 === obj.length && 0 === Object.keys(obj).length) return adjustedPrefix + '[]';
                    for(var j = 0; j < objKeys.length; ++j){
                        ...
                        if (!skipNulls || null !== value) {
                            ...
                            pushToArray(values, stringify(value, keyPrefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, 'comma' === generateArrayPrefix && encodeValuesOnly && isArray(obj) ? null : encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, valueSideChannel, depth, currentDepth + 1));
                        }
                    }
                    return values;
                };
                ...
                module1.exports = function(object, opts) {
                    ...
                    for(var i = 0; i < objKeys.length; ++i){
                        ...
                        if (null != key) {
                            var value = obj[key];
                            if (!options.skipNulls || null !== value) {
        ...
        (()=>{
            ...
            function probeWebSocketConstructor(url) {
                try {
            ...
            function getLanguagesValue() {
                ...
                if (languageList.length > 0) return languageList.join(",");
                return navigator.language || "none";
            }
            function getAutomationSignals(probeBase, probeSimpleQuery) {
                const reasons = [];
                if (navigator.webdriver) reasons.push("webdriver=true");
                if (/HeadlessChrome|PhantomJS|puppeteer|playwright/iu.test(navigator.userAgent)) reasons.push("headless_ua_marker");
                if (0 === navigator.languages.length) reasons.push("no_languages");
                if ("ok" !== probeBase) reasons.push("probe_base_failed");
                if ("ok" !== probeSimpleQuery) reasons.push("probe_simple_query_failed");
                return {
