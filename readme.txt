...
****Change:**
**
* Add installed versions to error reporting

= 11.2.0 (13 Sep 2026) =

**Improvement**
* Better error reporting for mobile phones when switching

**Change:**
* More status on Videomail are returned in API calls for better investigation

**Fix**
* Do not collect device information any longer as they are bogus

= 11.1.1 (2 Sep 2026) =

**Improvement**
* Improved camera handling for iPhones

**Fix**
* Do not display video replay buttons while recording

**Change:**
* Collect more error information about invalid camera constraints

= 11.1.0 (28 Aug 2026) =

**Improvement**
* Blocking bots/AI to reduce your own web traffic
* Better error messages
* Embrace native devices

**Change:**
* Bump Node.js v24 to v26
